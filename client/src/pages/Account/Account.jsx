  ...
  chest: [
    {
      ...
      detail: "Compound · Chest focus",
      sets: ["4×8", "80% 1RM", "Rest 90s"],
    },
    {
      icon: "📐",
      name: "Incline DB Press",
      detail: "Upper chest activation",
      sets: ["3×10", "70% effort", "Rest 75s"],
    },
    {
      icon: "🔄",
      name: "Cable Flys",
      detail: "Isolation · Stretch",
      sets: ["3×15", "Light-Med", "Rest 60s"],
    },
  ],
  back: [
    {
      ...
      detail: "Width builder · Lats",
      sets: ["4×6", "BW+10kg", "Rest 2min"],
    },
    {
      icon: "🚣",
      name: "Barbell Rows",
      detail: "Thickness · Mid-back",
      sets: ["4×8", "75% 1RM", "Rest 90s"],
    },
    {
      icon: "🔽",
      name: "Lat Pulldown",
      detail: "Lat sweep · Volume",
      sets: ["3×12", "Moderate", "Rest 60s"],
    },
  ],
  legs: [
    {
      icon: "🏆",
      name: "Back Squat",
      detail: "King of leg exercises",
      sets: ["5×5", "80% 1RM", "Rest 2min"],
    },
    {
      icon: "🦵",
      name: "Romanian Deadlift",
      detail: "Hamstrings & glutes",
      sets: ["4×10", "65% 1RM", "Rest 90s"],
    },
    {
      icon: "📦",
      name: "Leg Press",
      detail: "Volume & quad pump",
      sets: ["3×15", "Moderate", "Rest 60s"],
    },
  ],
  core: [
    {
      ...
      detail: "Full core tension",
      sets: ["4×12", "Slow tempo", "Rest 60s"],
    },
    {
      icon: "🧱",
      name: "Plank Variations",
      detail: "Stability & endurance",
      sets: ["3×60s", "Max tension", "Rest 45s"],
    },
    {
      icon: "🔄",
      name: "Hanging Leg Raise",
      detail: "Lower abs & hip flex",
      sets: ["3×15", "Controlled", "Rest 60s"],
    },
  ],
  fullbody: [
    {
      icon: "⚡",
      name: "Power Cleans",
      detail: "Full-body power",
      sets: ["5×3", "70% 1RM", "Rest 2min"],
    },
    {
      icon: "🏋️",
      name: "Deadlift",
      detail: "Total posterior chain",
      sets: ["4×5", "80% 1RM", "Rest 2min"],
    },
    {
      icon: "🤸",
      name: "Dumbbell Complex",
      detail: "6-move circuit",
      sets: ["3 rounds", "No rest", "Rest 90s"],
    },
  ],
  cardio: [
    {
      ...
      detail: "HIIT · Fat burn",
      sets: ["8×30s", "Max effort", "Rest 90s"],
    },
    {
      icon: "🚴",
      name: "Assault Bike HIIT",
      detail: "Cardio conditioning",
      sets: ["5×1min", "All-out", "Rest 2min"],
    },
    {
      icon: "🏃",
      name: "Rowing Machine",
      detail: "Low-impact endurance",
      sets: ["20min", "Moderate", "Steady"],
    },
  ],
};
...
const CO = {
  ...
  plugins: {
    legend: {
      labels: { color: "#9494a8", font: { family: "DM Sans", size: 11 } },
    },
  },
  scales: {
    x: {
      grid: { color: "rgba(255,255,255,0.05)" },
      ticks: { color: "#6b6b7a", font: { family: "DM Sans" } },
    },
    y: {
      grid: { color: "rgba(255,255,255,0.05)" },
      ticks: { color: "#6b6b7a", font: { family: "DM Sans" } },
...
function BodyAvatar({ gender, chest, waist, hips, thigh, arm, shoulders }) {
  ...
  if (gender === "female") {
    ...
    return (
      <svg viewBox="0 0 160 310" xmlns="http://www.w3.org/2000/svg">
        ...
        <path
          d="M58 20 Q56 6 80 4 Q104 6 102 20 Q110 12 106 4 Q100 -4 80 -4 Q60 -4 54 4 Q50 12 58 20Z"
          fill="#2d1f12"
        />
        <path
          d="M98 18 Q110 26 108 42 Q104 48 100 42 Q103 34 96 26Z"
          fill="#2d1f12"
        />
        ...
        />
        <path
          d="M79 30 Q77 35 79 37 Q80 38.5 81 37 Q83 35 81 30"
          stroke="#a87250"
          strokeWidth="1"
          fill="none"
          strokeLinecap="round"
        ...
        />
        <path
          d={`M${L} 69 Q${L - 2} 96 ${L} 115 Q54 124 80 128 Q106 124 ${R} 115 Q${R + 2} 96 ${R} 69Z`}
          fill="#880e4f"
          opacity="0.88"
        />
        <ellipse
        ...
        />
        <path
          d={`M${cx - ww - 32} 115 Q${cx - ww - 34} 138 ${cx - ww - 22} 150 Q${cx - ww - 12} 160 80 162 Q${cx + ww + 12} 160 ${cx + ww + 22} 150 Q${cx + ww + 34} 138 ${cx + ww + 32} 115 Q${cx + 26} 126 80 130 Q${cx - 26} 126 ${cx - ww - 32} 115Z`}
          fill="#6a0f3a"
        />
        <ellipse
          cx="80"
        ...
        />
        <path
          d={`M${cx - tw - 22} 161 Q${cx - tw - 30} 196 ${cx - tw - 26} 226 Q${cx - tw - 16} 238 ${cx - tw - 4} 234 Q${cx - tw + 2} 200 ${cx - tw + 2} 162Z`}
          fill="#880e4f"
          opacity="0.78"
        />
        <path
        ...
        />
        <path
          d={`M${cx - tw - 26} 226 Q${cx - tw - 30} 260 ${cx - tw - 26} 284 Q${cx - tw - 20} 293 ${cx - tw - 12} 290 Q${cx - tw - 8} 262 ${cx - tw - 4} 234Z`}
          fill="#6a0f3a"
        />
        <path
          d={`M${cx + tw + 26} 226 Q${cx + tw + 30} 260 ${cx + tw + 26} 284 Q${cx + tw + 20} 293 ${cx + tw + 12} 290 Q${cx + tw + 8} 262 ${cx + tw + 4} 234Z`}
        ...
        <ellipse cx={cx + tw + 19} cy="291" rx="10" ry="5" fill="#111" />
        <path
          d={`M${L} 69 Q${L - aw - 7} 80 ${L - aw - 11} 108 Q${L - aw - 11} 132 ${L - aw - 5} 142 Q${L - aw} 148 ${L - aw + 5} 144 Q${L - aw + 7} 120 ${L - 2} 95 Q${L} 80 ${L} 69Z`}
          fill="#880e4f"
          opacity="0.78"
        />
        <path
          d={`M${R} 69 Q${R + aw + 7} 80 ${R + aw + 11} 108 Q${R + aw + 11} 132 ${R + aw + 5} 142 Q${R + aw} 148 ${R + aw - 5} 144 Q${R + aw - 7} 120 ${R + 2} 95 Q${R} 80 ${R} 69Z`}
          fill="#880e4f"
          opacity="0.78"
        />
        <path
          d={`M${L - aw - 5} 142 Q${L - aw - 13} 166 ${L - aw - 11} 185 Q${L - aw - 7} 193 ${L - aw} 190 Q${L - aw + 4} 170 ${L - aw + 5} 144Z`}
          fill="#c4956e"
        />
        <path
          d={`M${R + aw + 5} 142 Q${R + aw + 13} 166 ${R + aw + 11} 185 Q${R + aw + 7} 193 ${R + aw} 190 Q${R + aw - 4} 170 ${R + aw - 5} 144Z`}
          fill="#c4956e"
        />
  ...
  return (
    <svg viewBox="0 0 160 310" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        d="M57 22 Q57 8 80 6 Q103 8 103 22 Q107 16 105 8 Q98 -2 80 -2 Q62 -2 55 8 Q53 16 57 22Z"
        fill="#2a1a0e"
      />
      ...
      />
      <path
        d="M79 29 Q76 35 77 38 Q78.5 40 80 39 Q81.5 40 83 38 Q84 35 81 29"
        stroke="#9a6238"
        strokeWidth="1.2"
        fill="none"
        strokeLinecap="round"
      ...
      />
      <path
        d="M60 38 Q62 50 80 54 Q98 50 100 38"
      ...
      <path
        d={`M${L} 74 Q${L - 2} 112 ${wL} 134 Q56 150 80 152 Q104 150 ${wR} 134 Q${R + 2} 112 ${R} 74Z`}
        fill="#1e2536"
      />
      <path
        d={`M${L + 4} 78 Q70 82 79 95 Q80 96 81 95 Q90 82 ${R - 4} 78`}
        stroke="rgba(255,107,26,0.14)"
        strokeWidth="1.5"
        fill="none"
      />
      <line
      ...
      />
      <path
        d="M72 100 Q80 103 88 100"
        stroke="rgba(255,107,26,0.08)"
        strokeWidth="1"
        fill="none"
      />
      <path
        d="M70 114 Q80 117 90 114"
        stroke="rgba(255,107,26,0.08)"
        strokeWidth="1"
        fill="none"
      />
      <path
        d={`M${wL} 134 Q48 158 80 162 Q112 158 ${wR} 134 Q104 150 80 152 Q56 150 ${wL} 134Z`}
        fill="#161e2c"
      />
      <ellipse
        cx="80"
      ...
      />
      <path
        d={`M${cx - tw - 22} 162 Q${cx - tw - 28} 196 ${cx - tw - 26} 226 Q${cx - tw - 16} 237 ${cx - tw - 6} 233 Q${cx - tw + 2} 201 ${cx - tw + 2} 163Z`}
        fill="#1e2536"
      />
      <path
        d={`M${cx + tw + 22} 162 Q${cx + tw + 28} 196 ${cx + tw + 26} 226 Q${cx + tw + 16} 237 ${cx + tw + 6} 233 Q${cx + tw - 2} 201 ${cx + tw - 2} 163Z`}
      ...
      />
      <path
        d={`M${cx - tw - 26} 226 Q${cx - tw - 30} 260 ${cx - tw - 26} 285 Q${cx - tw - 20} 294 ${cx - tw - 13} 291 Q${cx - tw - 9} 263 ${cx - tw - 6} 233Z`}
        fill="#161e2c"
      />
      <path
        d={`M${cx + tw + 26} 226 Q${cx + tw + 30} 260 ${cx + tw + 26} 285 Q${cx + tw + 20} 294 ${cx + tw + 13} 291 Q${cx + tw + 9} 263 ${cx + tw + 6} 233Z`}
      ...
      <ellipse cx={cx + tw + 19} cy="292" rx="11" ry="5.5" fill="#0d0d12" />
      <path
        d={`M${L} 74 Q${L - aw - 9} 85 ${L - aw - 13} 115 Q${L - aw - 13} 143 ${L - aw - 7} 153 Q${L - aw} 159 ${L - aw + 7} 155 Q${L - aw + 9} 129 ${L - 2} 101 Q${L} 85 ${L} 74Z`}
        fill="#1e2536"
      />
      <path
        d={`M${R} 74 Q${R + aw + 9} 85 ${R + aw + 13} 115 Q${R + aw + 13} 143 ${R + aw + 7} 153 Q${R + aw} 159 ${R + aw - 7} 155 Q${R + aw - 9} 129 ${R + 2} 101 Q${R} 85 ${R} 74Z`}
        fill="#1e2536"
      />
      <path
        d={`M${L - aw - 7} 153 Q${L - aw - 15} 180 ${L - aw - 13} 200 Q${L - aw - 9} 209 ${L - aw} 206 Q${L - aw + 5} 186 ${L - aw + 7} 155Z`}
        fill="#b07a50"
      />
      <path
        d={`M${R + aw + 7} 153 Q${R + aw + 15} 180 ${R + aw + 13} 200 Q${R + aw + 9} 209 ${R + aw} 206 Q${R + aw - 5} 186 ${R + aw - 7} 155Z`}
        fill="#b07a50"
      />
...
export default function Account() {
  ...
  const [chatMessages, setChatMessages] = useState([
    {
      role: "agent",
      text: "Hey Marcus! 👋 I'm your GymPro support agent. How can I help?",
      time: "Just now",
    },
    {
      role: "agent",
      text: "I can help with membership, classes, nutrition, or training! 💪",
      time: "Just now",
    },
  ]);
  ...
  const askAI = async () => {
    ...
    try {
      ...
      setAiResponse(
        data.content?.map((c) => c.text || "").join("") || "Try again!",
      );
    } catch {
  ...
  const sendChat = () => {
    ...
    setChatMessages((prev) => [
      ...prev,
      { role: "user", text: chatInput, time: now },
    ]);
    setChatInput("");
    setTimeout(() => {
      setChatMessages((prev) => [
        ...
        {
          role: "agent",
          text: CHAT_REPLIES[replyIdx.current++ % CHAT_REPLIES.length],
          time: now,
        },
      ]);
    }, 900);
  ...
  const cMax = Math.max(
    ...compareItems.map((i) => Math.max(i.current, i.goal)),
  );
  ...
  return (
    <>
      {/* TOAST */}
      <div className={`success-toast${toast.show ? " show" : ""}`}>
        {toast.msg}
      </div>
      ...
      <div className="main">
          ...
          <div className="profile-stats">
            ...
            <div className="stat">
              <div className="stat-num">
                84<small style={{ fontSize: 18 }}>kg</small>
              </div>
        ...
        <div className="mini-stats">
          {[
            ["2,840", "Calories Burned"],
            ["5h 40m", "Active This Week"],
            ["127", "Avg BPM"],
            ["94%", "Goal Progress"],
          ].map(([v, l]) => (
            <div className="mini-stat" key={l}>
              <div className="ms-val">{v}</div>
              <div className="ms-label">{l}</div>
            </div>
          ))}
        </div>
        ...
        <div className="card" style={{ marginBottom: 20 }}>
          ...
          <div className="section-title">
            🎯 Body Goal &amp; Target Proportions
          </div>
          <p style={{ fontSize: 13, color: "#6b6b7a", marginBottom: 22 }}>
            Set your primary goal, target weight, and ideal body proportions.
          </p>
          ...
          <div className="goal-body-select">
            {[
              ...
              <div
                key={name}
                className={`goal-type-btn${goalType === name ? " active" : ""}`}
                onClick={() => setGoalType(name)}
              >
          ...
          <p style={{ fontSize: 12, color: "#6b6b7a", margin: "16px 0 14px" }}>
            Target proportions (cm)
          </p>
          <div className="form-row-3">
            {[
              ["Target Weight (kg)", "weight"],
              [
                "Target " + (gender === "female" ? "Bust" : "Chest") + " (cm)",
                "chest",
              ],
              ["Target Waist (cm)", "waist"],
            ].map(([lbl, k]) => (
              <div className="field" key={k}>
                ...
                <input
                  ...
                  value={goalInputs[k]}
                  onChange={(e) =>
                    setGoalInputs((p) => ({ ...p, [k]: +e.target.value }))
                  }
                />
              </div>
            ))}
        ...
        <div className="card" style={{ marginBottom: 20 }}>
          ...
          <p style={{ fontSize: 13, color: "#6b6b7a", marginBottom: 22 }}>
            Log your measurements monthly. Your body silhouette updates live as
            you type.
          </p>
          <div className="tracker-layout">
            {/* AVATAR */}
            <div className="body-avatar-panel">
              <div className="body-avatar-title">
              ...
              <div className="avatar-svg-wrap">
                ...
                <div className="avatar-labels">
                  {[
                    [gender === "female" ? "Bust" : "Chest", av.chest],
                    ["Waist", av.waist],
                    ["Hips", av.hips],
                    ["Thigh", av.thigh],
                    ["Arm", av.arm],
                    ...
                    <div className="aml-row" key={lbl}>
                      ...
                      <span className="aml-val">
                        {m[lbl.toLowerCase()] ? val + " cm" : "—"}
                      </span>
                    </div>
                  ))}
                </div>
                <div className="avatar-legend">
                  ...
                  <span>
                    <span
                      className="legend-dot"
                      style={{ background: "rgba(240,238,234,0.35)" }}
                    />{" "}
                    Goal
                  </span>
                </div>
            ...
            <div className="measure-section">
              ...
              <div className="measure-group">
                ...
                <div className="measure-inputs">
                  {inp(
                    gender === "female" ? "Bust (cm)" : "Chest (cm)",
                    "chest",
                    "96",
                    "0.5",
                  )}
              ...
              <div style={{ display: "flex", gap: 12 }}>
                <button className="btn-primary" onClick={saveMeasurements}>
                  💾 Save This Month
                </button>
                <button className="btn-outline" onClick={clearM}>
                  Clear
                </button>
              </div>
            </div>
        ...
        <div className="card" style={{ marginBottom: 20 }}>
          ...
          <div className="chart-tabs">
            {[
              ...
              <button
                key={id}
                className={`chart-tab${chartTab === id ? " active" : ""}`}
                  ...
                  <div key={item.label}>
                    <div className="compare-row-top">
                      ...
                      <div className="c-vals">
                        ...
                        <span style={{ color: dc, fontWeight: 700 }}>
                          {+diff > 0 ? "+" : ""}
                          {diff}
                        </span>
                      </div>
        ...
        <div className="grid">
          ...
          <div className="card grid-full">
            ...
            <p style={{ fontSize: 13, color: "#6b6b7a", marginBottom: 20 }}>
              Choose your primary focus area for tailored workout
              recommendations.
            </p>
            <div className="target-grid">
              {[
                ["💪", "Chest & Arms", "chest", "Push power & definition"],
                ["🦴", "Back & Lats", "back", "Width & thickness"],
                ["🦵", "Legs & Glutes", "legs", "Strength & size"],
                ["🎯", "Core & Abs", "core", "Stability & tone"],
                ["⚡", "Full Body", "fullbody", "Total conditioning"],
                ["🏃", "Cardio & HIIT", "cardio", "Burn & endurance"],
              ].map(([icon, name, key, desc]) => (
                <button
                  key={key}
                  className={`target-btn${activeTarget === key ? " active" : ""}`}
          ...
          <div className="card">
            ...
            <div style={{ marginTop: 18 }}>
              {[
                ["Bench Press", "100/120kg", 83],
                ["Squat", "130/150kg", 87],
                ["Deadlift", "160/180kg", 89],
                ["Overhead Press", "65/80kg", 81],
                ["Pull-ups", "18/25 reps", 72],
              ].map(([name, val, pct]) => (
          ...
          <div className="card">
            ...
            <div style={{ marginTop: 18 }}>
              ...
              >
                ...
                <div style={{ fontSize: 12, color: "#6b6b7a", marginTop: 4 }}>
                  5:30 PM · Bench Press, Rows, OHP, Dips
                </div>
              </div>
            </div>
          </div>
