...
# Enhanced RegisterRequest (replaces basic version)
...
# Enhanced TokenResponse (replaces basic version)
...
# Enhanced ChangePasswordRequest (replaces basic version)
...
# ---------------------------------------------------------------------------
# Account Management Schemas (from main schemas file)
# ---------------------------------------------------------------------------
...
# LoginRequest and TokenResponse are already defined above in enhanced form
...
# Password Reset Schemas are already defined above in enhanced form
...
# Registration Request is already defined above in enhanced form
...
class ExcursionBookingResponse(BaseModel):
    id: uuid.UUID
...
class MyBookingsResponse(BaseModel):
    bookings: List[ExcursionBookingResponse]
    total: int
...
# ---------------------------------------------------------------------------
# Extended Consultation Schemas (from main schemas file)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Extended Shop Schemas (from main schemas file)
# ---------------------------------------------------------------------------
...
class ShopWishlistItemResponse(BaseModel):
    product_id: str
    name: str
    price: float
    image_url: Optional[str] = None
...
class ShopWishlistResponse(BaseModel):
    items: List[ShopWishlistItemResponse]
    total: int
...
class ExtendedOrderResponse(BaseModel):
    id: uuid.UUID
    order_reference: str
    order_status: str
    payment_status: str
...
class OrdersListResponse(BaseModel):
    orders: List[ExtendedOrderResponse]
    total: int
